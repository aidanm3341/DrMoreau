    ...
    public static BodyPart getPart(String name, int level) throws SlickException
    {
        ...
        switch(name)
        {
            ...
            case "rat_body":
                ...
                return new BodyBodyPart("rat_body", "body", null, 5, ratBody,null, connectors);

            case "bunny_head":
                Image bunnyHead = ResourceLoader.getImage("bunny_head");
                atk = new Attack("Chew", level+1);
                return new BodyPart("bunny_head", "head", atk, 5, bunnyHead,
            ...
            case "bunny_leg":
                ...
                return new BodyPart("bunny_leg", "leg", atk, 5, bunnyLeg,
            ...
            case "bunny_body":
                ...
                return new BodyBodyPart("bunny_body", "body", null, 5, bunnyBody,null, connectors);

            case "penguin_head":
                Image penguinHead = ResourceLoader.getImage("penguin_head").getScaledCopy(0.5f);
                atk = new Attack("Peck", 4);
                return new BodyPart("penguin_head", "head", atk, 5, penguinHead,
            ...
            case "penguin_leg":
                ...
                return new BodyPart("penguin_leg", "leg", atk, 5, penguinLeg,
            ...
            case "penguin_arm":
                ...
                return new BodyPart("penguin_arm", "arm", atk, 5, penguinArm,
            ...
            case "penguin_tail":
                ...
                return new BodyPart("penguin_tail", "tail", atk, 5, penguinTail,
            ...
            case "penguin_body":
                ...
                return new BodyBodyPart("penguin_body", "body", null, 5, penguinBody,null, connectors);
            ...
            case "lion_leg":
                ...
                return new BodyPart("lion_leg", "leg", atk, 5, lionLeg,
            ...
            case "lion_arm":
                ...
                return new BodyPart("lion_arm", "arm", atk, 5, lionArm,
            ...
            case "lion_body":
                ...
                return new BodyBodyPart("lion_body", "body", null, 5, lionBody,null, connectors);
            ...
            case "elephant_leg":
                ...
                return new BodyPart("elephant_leg", "leg", atk, 5, elephantLeg,
            ...
            case "elephant_body":
                ...
                return new BodyBodyPart("elephant_body", "body", null, 5, elephantBody,null, connectors);

            case "beaver_head":
                Image beaverHead = ResourceLoader.getImage("beaver_head");
                atk = new Attack("Chew", 4);
                return new BodyPart("beaver_head", "head", atk, 2, beaverHead,
            ...
            case "beaver_leg":
                ...
                return new BodyPart("beaver_leg", "leg", atk, 5, beaverLeg,
            ...
            case "golden_monkey_arm":
                ...
                return new BodyPart("golden_monkey_arm", "arm", atk, 6, goldenMonkeyArm,
